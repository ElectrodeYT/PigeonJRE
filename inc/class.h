...
struct CPInfo {
    ...
    std::string toString() {
        ...
        case CPTag::ClassReference:  { return "ClassReference"; }
        case CPTag::StringReference:  { return "StringReference"; }
        case CPTag::FieldReference:  { return "FieldReference"; }
        case CPTag::MethodReference:  { return "MethodReference"; }
        case CPTag::InterfaceMethodReference:  { return "InterfaceMethodReference"; }
        case CPTag::NameAndTypeDescriptor:  { return "NameAndTypeDescriptor"; }
...
public:
    ...
    CPInfo& readCPEntry(uint16_t pos) {
        return constant_pool[pos - 1];
    }
